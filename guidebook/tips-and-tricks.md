...
* Full-block [devices](tl2-mechanics/devices.md) in groups of 8 or less unless you deeply understand how [channels](tl2-mechanics/channels.md)
...
* The best way to keep your network clean is to not put random mob loot like swords and armor in. Each unique combination of
  enchantment and durability is another [type](tl2-mechanics/bytes-and-types.md).
