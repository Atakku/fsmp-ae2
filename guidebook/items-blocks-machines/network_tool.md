...
While it retains the wrench's ability to quickly disassemble things and pull [subparts](../tl2-mechanics/cable-subparts.md)
off of a cable, it cannot rotate things.

It has 9 slots in which to store [upgrade cards](upgrade_cards.md), and they will be available in any TL2 device UI if the tool
...
*   A toggle for the global setting to view energy in TL or E/FE
*   The amount of [energy](../tl2-mechanics/energy.md) stored in the network, and the network's maximum energy capacity
...
[Subnetworks](../tl2-mechanics/subnetworks.md).
