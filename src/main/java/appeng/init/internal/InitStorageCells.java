...
public final class InitStorageCells {
    ...
    private static final ResourceLocation MODEL_CELL_FLUIDS_4K = ResourceLocation.parse(
            "tl2:block/drive/cells/4k_fluid_cell");
