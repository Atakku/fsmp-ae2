...
public final class CellConfig {
    ...
    public static ConfigInventory create(Set<TLKeyType> supportedTypes, ItemStack is, int size) {
    ...
    public static ConfigInventory create(Set<TLKeyType> supportedTypes, ItemStack is) {
        var holder = new Holder(is);
    ...
    private static class Holder {
        ...
        public void load() {
            inv.readFromList(stack.getOrDefault(TLComponents.STORAGE_CELL_CONFIG_INV, List.of()));
        }

        public void save() {
            stack.set(TLComponents.STORAGE_CELL_CONFIG_INV, inv.toList());
        }
    }
}
