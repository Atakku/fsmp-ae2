...
public class TL2LootTableProvider extends LootTableProvider {
    ...
    public TL2LootTableProvider(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> provider) {
