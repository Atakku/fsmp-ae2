...
import appeng.datagen.providers.loot.TL2LootTableProvider;
...
public class TL2DataGenerators {
    ...
    public static void onGatherData(GatherDataEvent event) {
        ...
        // Loot
        pack.addProvider(packOutput -> new TL2LootTableProvider(packOutput, registries));
