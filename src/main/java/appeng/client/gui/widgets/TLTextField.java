 ...
 */
public class TLTextField extends EditBox implements IResizableWidget, ITooltip {
     ...
     */
    public TLTextField(ScreenStyle style, Font fontRenderer, int xPos, int yPos, int width,
            int height) {
