...
public class TLBaseBlockItem extends BlockItem {

    private final TLBaseBlock blockType;

    public TLBaseBlockItem(Block id, Properties props) {
        super(id, props);
        this.blockType = (TLBaseBlock) id;
    }
