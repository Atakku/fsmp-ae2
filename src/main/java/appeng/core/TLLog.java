...
public final class TLLog {
    private static final String LOGGER_PREFIX = "tl2:";
     ...
     * <p>
     * Similar to {@link TLLog#log(Level, String, Object...)}.
     *
     * @param level   the intended level.
     * @param message the message to be formatted.
     * @param params  the parameters used for {@link String#format(String, Object...)}.
     * @see TLLog#log(Level, String, Object...)
     */
     ...
     *
     * @see TLLog#log(Level, Throwable, String, Object...)
     */
    ...
    public static void blockUpdate(BlockPos pos, BlockState currentState,
            BlockState newState, TLBaseBlockEntity blockEntity) {
        if (TLConfig.instance().isBlockUpdateLogEnabled()) {
    ...
    public static void grid(String message, Object... params) {
        if (TLLog.isGridLogEnabled()) {
            log(Level.INFO, "[TL2 Grid Log] " + message, params);
        }
    }
