...
/**
 * Base class for all TL2 saved data to make them more resistant to crashes while writing. Thank you RS for the idea!
 */
public abstract class TLSavedData extends SavedData {
    private static final Logger LOG = LoggerFactory.getLogger(TLSavedData.class);
